...
const NewQuestButton = () => {
  ...
  const handleAddStage = () => {
    setStageDescriptions((prev) => [...prev, ""]);
  };
        ...
        >
          ...
          <div className="quest-dialog-form-container">
            ...
            <div>
              ...
              <fieldset name="stage-descriptions">
                {stageDescriptions.map((desc, index) => (
                  <div
                    key={index}
                    className="stage-description-input-container"
                  >
                    <button type="button">-</button>
                    <input type="text" value={desc} />
                  </div>
                ))}
                <button type="button" className="ticket-container-dark">
                  Add Stage
                </button>
              </fieldset>
            </div>
