...
import QuestDropdown from "../components/QuestDropdown";
...
const QuestsPane = () => {
  ...
  const [selectedQuestRealmTitle, setSelectedQuestRealmTitle] = useState<string | null>(null);
  ...
  return (
    <div className="quest-pane">
      ...
      <section className="ticket-border-gradient">
        {selectedQuest && (
          <QuestStages quest={selectedQuest} realmTitle={realm} />
        )}
      </section>
      <section className="ticket-border-gradient">
